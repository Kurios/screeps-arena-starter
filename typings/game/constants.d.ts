declare module "game/constants" {
    ...
    export const RANGED_ATTACK_DISTANCE_RATE:number; //Fixed Type
    ...
    export const OBSTACLE_OBJECT_TYPES:number; //Fixed Type
    ...
    export const CONSTRUCTION_COST:number; //Fixed Type
    export const STRUCTURE_PROTOTYPES:number; //Fixed Type
